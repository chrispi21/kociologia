...
from kociologia.domain.opisywacz_kotow import opisywacz_kotow
from kociologia.domain.wygeneruj_obraz_kota import wygeneruj_obraz_kota
from kociologia.domain.wykrywacz_ras_kotow import wykrywacz_ras_kotow
